    ...
    <form class="form" @submit.prevent="submit" method="POST" enctype="multipart/form-data">
      <div class="form__item form__inline">
        <div class="form__inline-item">
          <label for="person">
            <input type="radio" id="person" name="platform" v-model="form.platform" value="In Person" checked>
            In Person
        ...
        <div class="form__inline-item">
          <label for="digital">
            <input type="radio" id="digital" name="platform" v-model="form.platform" value="Digital">
            Digital
          </label>
      ...
      <div class="form-split">
        <div class="form-split__item">
          ...
          <transition name="fade-form-element">
            <div class="form__item" v-show="form.platform==='In Person'">
        ...
        <div class="form-split__item">
          ...
          <transition name="fade-form-element">
            <div class="form__item" v-show="form.platform==='Digital'">
              <div class="form__input">
...
export default {
  ...
  setup (props) {
    ...
    function submit() {
      if(props.editPath) {
        Inertia.post(route().current('manage_engagement.edit') ? route('manage_engagement.update', {id: props.engagement.id}) : route('engagement.update', {id: props.engagement.id}), form);
      }
      else {
        Inertia.post(route().current('manage_engagement.store') ? route('manage_engagement.store') : route('manage_engagement.store'), form)
      }
    }
  ...
  computed: {
    filterKee(props) {
      ...
      return props.kees.filter(function(kee){
        return kee.firstname.toLowerCase().indexOf(self.search.toLowerCase())>= 0;
      });
    },
  },
  mounted() {
