...
export default {
  ...
  setup(props) {
    const form = reactive({
      understanding_data: props.recent_rank && props.recent_rank.understanding_data_status === 'Foundation' ? 'understanding_data_foundation' :
        props.recent_rank.understanding_data_status === 'General' ? 'understanding_data_general' : props.recent_rank.understanding_data_status === 'Advanced' ?
          'understanding_data_advanced' : props.recent_rank.understanding_data_status === 'Expert' ? 'understanding_data_expert' : null,

      commitment: props.recent_rank && props.recent_rank.commitment_status === 'Low' ? 'commitment_low' :
        props.recent_rank.commitment_status === 'Medium' ? 'commitment_medium' : props.recent_rank.commitment_status === 'High' ?
          'commitment_high' : null,

      performance_delivery: props.recent_rank && props.recent_rank.performance_status === 'Foundation' ? 'performance_delivery_foundation' :
        props.recent_rank.performance_status === 'General' ? 'performance_delivery_general' : props.recent_rank.performance_status === 'Advanced' ?
          'performance_delivery_advanced' : props.recent_rank.performance_status === 'Expert' ? 'performance_delivery_expert' : null,
      attendance: 'Yes',
      rank: null,
      overall: null,
